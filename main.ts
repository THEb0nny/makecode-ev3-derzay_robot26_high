...
motions.setDistRollingAfterIntersection(55); // Установка расстояния прокатки после опредления перекрёстка при движении по линии
...
sensors.setColorSensorMinRgbValues(colorSensor, 10, 10, 150); // Значения датчика цвета когда ничего нет
