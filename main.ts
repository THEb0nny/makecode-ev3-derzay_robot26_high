...
navigation.buildGraph([
    { from: 0, to: 1, direction: NavDirection.RightLeft, weight: 1 },
    { from: 1, to: 2, direction: NavDirection.UpDown, weight: 1 },
    { from: 1, to: 3, direction: NavDirection.RightLeft, weight: 1 },
    { from: 3, to: 4, direction: NavDirection.UpDown, weight: 1 },
    { from: 3, to: 5, direction: NavDirection.RightLeft, weight: 1 },
    { from: 5, to: 6, direction: NavDirection.UpDown, weight: 1 },
    { from: 5, to: 7, direction: NavDirection.RightLeft, weight: 1 },
    { from: 7, to: 8, direction: NavDirection.UpDown, weight: 1 },
    { from: 8, to: 9, direction: NavDirection.RightLeft, weight: 1 },
    { from: 8, to: 10, direction: NavDirection.UpDown, weight: 1 },
    { from: 10, to: 11, direction: NavDirection.RightLeft, weight: 1 },
    { from: 10, to: 12, direction: NavDirection.UpDown, weight: 1 },
    { from: 12, to: 13, direction: NavDirection.RightLeft, weight: 1 },
    { from: 12, to: 14, direction: NavDirection.LeftRight, weight: 1 },
    { from: 12, to: 15, direction: NavDirection.UpDown, weight: 1 },
    { from: 15, to: 16, direction: NavDirection.RightLeft, weight: 1 },
    { from: 15, to: 17, direction: NavDirection.UpDown, weight: 1 },
    { from: 17, to: 18, direction: NavDirection.RightLeft, weight: 1 },
    { from: 17, to: 19, direction: NavDirection.UpDown, weight: 1 },
    { from: 19, to: 20, direction: NavDirection.LeftRight, weight: 1 },
    { from: 20, to: 21, direction: NavDirection.DownUp, weight: 1 },
    { from: 20, to: 22, direction: NavDirection.LeftRight, weight: 1 },
    { from: 22, to: 23, direction: NavDirection.DownUp, weight: 1 },
    { from: 22, to: 24, direction: NavDirection.LeftRight, weight: 1 },
    { from: 24, to: 25, direction: NavDirection.DownUp, weight: 1 },
    { from: 24, to: 26, direction: NavDirection.LeftRight, weight: 1 },
    { from: 26, to: 27, direction: NavDirection.RightLeft, weight: 1 },
    { from: 27, to: 28, direction: NavDirection.DownUp, weight: 1 },
]);
